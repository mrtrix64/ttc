...
FROM cms_content INNER JOIN cms_speakers ON cms_content.speaker = cms_speakers.spkr_id INNER JOIN schedule_title ON cms_content.date_time = schedule_title.schedule_title_id WHERE cms_content.publish = 'y' AND cms_content.cms_cat = 8 ORDER BY cms_content.sort_order ASC";
