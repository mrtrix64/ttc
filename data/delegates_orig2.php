...
header("Content-Type: application/xml");
 echo "<recordset>"."\n";
    while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
		...
		echo "<First_Name><![CDATA[".htmlspecialchars($row['First_Name'], ENT_NOQUOTES)."]]></First_Name>"."\n";
		echo "<Last_Name><![CDATA[".htmlspecialchars($row['Last_Name'], ENT_NOQUOTES)."]]></Last_Name>"."\n";
		echo "<Organization><![CDATA[".htmlspecialchars($row['Organization'], ENT_NOQUOTES)."]]></Organization>"."\n";
