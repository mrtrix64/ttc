// JavaScript Document
var dsSponsors = new Spry.Data.XMLDataSet("http://localhost/ttc_ios/ttc_ios_2014/ttc_ios/data/sponsors.php?view_xml=1?view_xml=1", "recordset/record", {sortOrderOnLoad: "ascending"});
dsSponsors.setColumnType("description", "html");
dsSponsors.setColumnType("aims", "html");
dsSponsors.setColumnType("website", "html");
	var dsSchedule = new Spry.Data.XMLDataSet("http://localhost/ttc_ios/ttc_ios_2014/ttc_ios/data/schedule.php?view_xml=1", "recordset/record", {sortOnLoad: "sort_order", sortOrderOnLoad: "ascending"});
dsSchedule.setColumnType("title", "html");
dsSchedule.setColumnType("sort_order", "number");
	var dsHotels = new Spry.Data.XMLDataSet("http://localhost/ttc_ios/ttc_ios_2014/ttc_ios/data/hotels.php?view_xml=1", "recordset/record", {sortOnLoad: "hotel_name", sortOrderOnLoad: "ascending"});
...
var dsSpecialist = new Spry.Data.XMLDataSet("http://localhost/ttc_ios/ttc_ios_2014/ttc_ios/data/specialist.php?view_xml=1", "recordset/record");
...
var dsPlenary = new Spry.Data.XMLDataSet("http://localhost/ttc_ios/ttc_ios_2014/ttc_ios/data/plenary.php?view_xml=1", "recordset/record");
...
var dsForum = new Spry.Data.XMLDataSet("http://localhost/ttc_ios/ttc_ios_2014/ttc_ios/data/marketing.php?view_xml=1", "recordset/record");
dsForum.setColumnType("cms_content", "html");
dsForum.setColumnType("sort_order", "number");
dsForum.setColumnType("spkr_content", "html");
var dsDates = new Spry.Data.XMLDataSet("http://localhost/ttc_ios/ttc_ios_2014/ttc_ios/data/dates.php?view_xml=1?view_xml=1", "recordset/record", {sortOnLoad: "schedule_title_id", sortOrderOnLoad: "ascending"});
